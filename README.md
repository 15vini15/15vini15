...
Desenvolvedor Full Stack, trabalhando com HTML, CSS, JavaScript, Python e Django, atuando tanto no front-end quanto no back-end. Tenho foco em criar aplicações funcionais, bem estruturadas e com boa experiência para o usuário. Gosto de transformar ideias em soluções reais, desenvolvendo desde interfaces responsivas até APIs e sistemas completos. Estou sempre buscando evoluir tecnicamente, aprender novas ferramentas e aprimorar boas práticas de desenvolvimento.
